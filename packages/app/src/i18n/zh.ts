...
export const dict = {
  ...
  "dialog.provider.opencode.note": "使用 KZCode Zen 或 API 密钥连接",
  ...
  "dialog.model.unpaid.freeModels.title": "KZCode 提供的免费模型",
  ...
  "provider.connect.apiKey.description":
    "输入你的 {{provider}} API 密钥以连接帐户，并在 KZCode 中使用 {{provider}} 模型。",
  ...
  "provider.connect.opencodeZen.line1": "KZCode Zen 为你提供一组精选的可靠优化模型，用于代码智能体。",
  ...
  "provider.connect.oauth.code.visit.suffix": " 获取授权码，以连接你的帐户并在 KZCode 中使用 {{provider}} 模型。",
  ...
  "provider.connect.oauth.auto.visit.suffix": " 并输入以下代码，以连接你的帐户并在 KZCode 中使用 {{provider}} 模型。",
  ...
  "dialog.server.description": "切换此应用连接的 KZCode 服务器。",
  ...
  "toast.update.description": "KZCode 有新版本 ({{version}}) 可安装。",
  ...
  "error.page.report.prefix": "请将此错误报告给 KZCode 团队",
  ...
  "error.chain.mcpFailed": 'MCP 服务器 "{{name}}" 启动失败。注意: KZCode 暂不支持 MCP 认证。',
  ...
  "home.sessions.empty.description": "为该项目开始新会话",
  ...
  "settings.desktop.wsl.description": "在 Windows 的 WSL 环境中运行 KZCode 服务器。",
  ...
  "settings.general.row.language.description": "更改 KZCode 的显示语言",
  ...
  "settings.general.row.appearance.description": "自定义 KZCode 在你的设备上的外观",
  "settings.general.row.colorScheme.title": "配色方案",
  "settings.general.row.colorScheme.description": "选择 KZCode 跟随系统、浅色或深色主题",
  "settings.general.row.theme.title": "主题",
  "settings.general.row.theme.description": "自定义 KZCode 的主题。",
  ...
  "settings.general.row.pinchZoom.description": "允许触控板捏合和 Ctrl+滚轮缩放",
  ...
  "settings.updates.row.startup.description": "在 KZCode 启动时自动检查更新",
  ...
  "settings.updates.toast.latest.description": "你正在使用最新版本的 KZCode。",
  ...
  "wsl.onboarding.openDistroOnce": "打开 {{distro}} 一次以完成设置。",
  "wsl.onboarding.finishingDistro": "正在完成 {{distro}} 的设置。",
  "wsl.onboarding.pickDistro": "选择一个发行版或在下方安装。",
  "wsl.onboarding.checkingOpencode": "正在检查 KZCode...",
  "wsl.onboarding.checkingOpencodeIn": "正在检查 {{distro}} 中的 KZCode...",
  "wsl.onboarding.updatingOpencode": "正在更新 KZCode...",
  "wsl.onboarding.updatingOpencodeIn": "正在更新 {{distro}} 中的 KZCode...",
  "wsl.onboarding.updateOpencodeIn": "更新 {{distro}} 中的 KZCode。",
  "wsl.onboarding.updateOpencode": "更新 KZCode",
  "wsl.onboarding.opencodeReadyIn": "{{distro}} 中的 KZCode 已就绪。",
  "wsl.onboarding.opencodeReady": "KZCode 已就绪。",
  "wsl.onboarding.installOpencodeIn": "在 {{distro}} 中安装 KZCode。",
  "wsl.onboarding.installOpencode": "安装 KZCode",
  ...
  "wsl.onboarding.windowsRestartRequired": "请重启 Windows 以完成 WSL 安装，然后重新打开 KZCode。",
