export const dict = {
  ...
  "dialog.model.unpaid.freeModels.title": "Free models provided by KZCode",
  ...
  "provider.connect.apiKey.description":
    "Enter your {{provider}} API key to connect your account and use {{provider}} models in KZCode.",
  "provider.connect.apiKey.label": "{{provider}} API key",
  "provider.connect.apiKey.placeholder": "API key",
  "provider.connect.apiKey.required": "API key is required",
  "provider.connect.opencodeZen.line1":
    "KZCode Zen gives you access to a curated set of reliable optimized models for coding agents.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    " to collect your authorization code to connect your account and use {{provider}} models in KZCode.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " and enter the code below to connect your account and use {{provider}} models in KZCode.",
  ...
  "dialog.server.description": "Switch which KZCode server this app connects to.",
  ...
  "wsl.onboarding.step.opencode": "KZCode",
  ...
  "wsl.onboarding.checkingOpencode": "Checking KZCode...",
  "wsl.onboarding.checkingOpencodeIn": "Checking KZCode in {{distro}}...",
  "wsl.onboarding.updatingOpencode": "Updating KZCode...",
  "wsl.onboarding.updatingOpencodeIn": "Updating KZCode in {{distro}}...",
  "wsl.onboarding.updateOpencodeIn": "Update KZCode in {{distro}}.",
  "wsl.onboarding.updateOpencode": "Update KZCode",
  "wsl.onboarding.opencodeReadyIn": "KZCode is ready in {{distro}}.",
  "wsl.onboarding.opencodeReady": "KZCode is ready.",
  "wsl.onboarding.installOpencodeIn": "Install KZCode in {{distro}}.",
  "wsl.onboarding.installOpencode": "Install KZCode",
  ...
  "wsl.onboarding.windowsRestartRequired": "Restart Windows to finish installing WSL, then reopen KZCode.",
  ...
  "toast.update.description": "A new version of KZCode ({{version}}) is now available to install.",
  ...
  "error.page.report.prefix": "Please report this error to the KZCode team",
  ...
  "error.chain.mcpFailed": 'MCP server "{{name}}" failed. Note, KZCode does not support MCP authentication yet.',
  ...
  "sidebar.gettingStarted.line1": "KZCode includes free models so you can start immediately.",
  ...
  "app.name.desktop": "KZCode Desktop",
  ...
  "settings.desktop.wsl.description": "Run the KZCode server inside WSL on Windows.",
  ...
  "settings.general.row.language.description": "Change the display language for KZCode",
  ...
  "settings.general.row.appearance.description": "Customise how KZCode looks on your device",
  "settings.general.row.colorScheme.title": "Color scheme",
  "settings.general.row.colorScheme.description": "Choose whether KZCode follows the system, light, or dark theme",
  "settings.general.row.theme.title": "Theme",
  "settings.general.row.theme.description": "Customise how KZCode is themed.",
  ...
  "settings.updates.row.startup.description": "Automatically check for updates when KZCode launches",
  ...
  "settings.updates.toast.latest.description": "You're running the latest version of KZCode.",
