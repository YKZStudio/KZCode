...
import kzcodeThemeJson from "./themes/kzcode.json"
import kzcodeOceanThemeJson from "./themes/kzcode-ocean.json"
import kzcodeForestThemeJson from "./themes/kzcode-forest.json"
import kcodesMidnightThemeJson from "./themes/kzcode-midnight.json"
...
export const kzcodeTheme = kzcodeThemeJson as DesktopTheme
export const kzcodeOceanTheme = kzcodeOceanThemeJson as DesktopTheme
export const kzcodeForestTheme = kzcodeForestThemeJson as DesktopTheme
export const kcodesMidnightTheme = kcodesMidnightThemeJson as DesktopTheme
...
export const DEFAULT_THEMES: Record<string, DesktopTheme> = {
  kzcode: kzcodeTheme,
  "kzcode-ocean": kzcodeOceanTheme,
  "kzcode-forest": kzcodeForestTheme,
  "kzcode-midnight": kcodesMidnightTheme,
  "oc-2": oc2Theme,
  amoled: amoledTheme,
  aura: auraTheme,
  ayu: ayuTheme,
