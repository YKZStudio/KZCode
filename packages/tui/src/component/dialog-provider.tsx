...
export function DialogProvider() {
  ...
  return <DialogSelect title={t("Connect a provider")} options={options()} />
}
      ...
      description={
        {
          opencode: (
            <box gap={1}>
              <text fg={theme.textMuted}>
                {t(
                  "KZCode Zen gives you access to all the best coding models at the cheapest prices with a single API key.",
                )}
              </text>
              <text fg={theme.text}>
                {t("Go to")}{" "}
          ...
          "opencode-go": (
            <box gap={1}>
              <text fg={theme.textMuted}>
                {t(
                  "KZCode Go is a $10 per month subscription that provides reliable access to popular open coding models with generous usage limits.",
                )}
              </text>
              <text fg={theme.text}>
                {t("Go to")}{" "}
                <span style={{ fg: theme.primary }}>https://opencode.ai/go</span>{" "}
                {t("and enable KZCode Go")}
              </text>
            </box>
          ),
