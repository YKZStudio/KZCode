...
export function Session() {
  ...
  createEffect(() => {
    ...
    void (async () => {
      ...
      if (!result.data) {
        toast.show({
          message: t("Session not found: {id}", { id: sessionID }),
          variant: "error",
          duration: 5000,
        })
        navigate({ type: "home" })
                        ...
                        {(function () {
                          ...
                          return (
                            ...
                            >
                              ...
                              >
                                <text fg={theme.textMuted}>{t("{count} message(s) reverted", { count: revert()!.reverted.length })}</text>
      ...
      <Show when={text()}>
        ...
        >
          ...
          >
            ...
            >
              <text fg={theme.textMuted}>
                <span style={{ bg: color(), fg: queuedFg(), bold: true }}> {t("QUEUED")} </span>
              </text>
            </Show>
          </box>
        </box>
